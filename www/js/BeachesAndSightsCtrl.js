...
var app = angular.module('Sukosan')
    .controller('BeachesAndSightsCtrl', function ($scope,$cordovaSocialSharing, $ionicLoading, $rootScope, $http, $ionicPopup, $cordovaSQLite,$cordovaGeolocation, $cordovaLocalNotification, $ionicPlatform, $state, $stateParams, $translate) {
        ...
        console.error("DASD?" + err[0]);
            ...
            $cordovaSQLite.execute(db, query, []).then(function (res) {
                var request = $http({
                    method: "POST",
                    url: 'http://appeventnet.com/rest/events.php',
                    data: { id: "11",category: window.localStorage.getItem("id"), jezik: window.localStorage.getItem("language") },
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
